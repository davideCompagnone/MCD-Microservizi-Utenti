from ..config import DynamoCredentials
import boto3
...
class DynamoContext:
    ...
    def __exit__(self, error: Exception, value: object, traceback: object):
        self.connection.dynamo.meta.client.close()


class DynamoConnection:
    def __init__(self, table_name: str, index_name: str):
        self.credentials = DynamoCredentials()
...
def insert_user(
    ...
    try:
        ...
        print(
            "Errore durante l'inserimento dell'utente:", e.response["Error"]["Message"]
        )
        return -2
...
def delete_user(user_id):
    ...
    try:
        ...
        print(
            "Errore durante l'eliminazione dell'utente:", e.response["Error"]["Message"]
        )
        return -1
...
def get_users(user_id=None):
    ...
    try:
        ...
        print(
            "Errore durante il recupero degli utenti:", e.response["Error"]["Message"]
        )
        return -1
...
def delete_table(table_name):
    ...
    try:
        ...
        print(
            f"Errore durante l'eliminazione della tabella '{table_name}':",
            e.response["Error"]["Message"],
        )
